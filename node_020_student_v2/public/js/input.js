document.addEventListener("DOMContentLoaded", () => {
  ...
  // const st_num = document.querySelector("inqut[name='st_num']")
  ...
  /*
  먼저 btn_submit(button) 의 click event를 최소한으로 테스트를 하고 
  이후에 btn_submit null pointer exception을 일으키는 현상을 방지하기 위하여
